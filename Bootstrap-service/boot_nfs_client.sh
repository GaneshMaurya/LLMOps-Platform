...
MOUNT_ROOT="/exports"
ENV_FILE="${MOUNT_ROOT}/system_services/.env"
...
mkdir -p ${MOUNT_ROOT}/system_services
mkdir -p ${MOUNT_ROOT}/user_applications
...
mount_nfs_dir "/exports/system_services" "${MOUNT_ROOT}/system_services" 
mount_nfs_dir "/exports/user_applications" "${MOUNT_ROOT}/user_applications"
