...
EXPORT_DIRS=("/exports/models" "/exports/system_services" "/exports/user_applications")
...
/exports/system_services $SUBNET(rw,sync,no_subtree_check,no_root_squash)
/exports/user_applications $SUBNET(rw,sync,no_subtree_check,no_root_squash)
EOF
